...
define('artic-demo/tests/unit/application/serializer-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('artic-demo/tests/unit/application/serializer-test.jshint', ['exports'], function (exports) {
  'use strict';
...
define('artic-demo/tests/unit/repositories/index/route-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/repositories/index/route-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/repositories/index/route-test.js should pass jshint.');
  });
});
define('artic-demo/tests/unit/repositories/route-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:repositories', 'Unit | Route | repositories', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('artic-demo/tests/unit/repositories/route-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/repositories/route-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/repositories/route-test.js should pass jshint.');
  });
});
define('artic-demo/tests/unit/repository/route-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:repository', 'Unit | Route | repository', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('artic-demo/tests/unit/repository/route-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/repository/route-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/repository/route-test.js should pass jshint.');
  });
});
/* jshint ignore:start */
