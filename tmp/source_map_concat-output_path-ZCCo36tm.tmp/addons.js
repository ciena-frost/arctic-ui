...
define('ember-api-actions/utils/build-url', ['exports', 'ember'], function (exports, _ember) {
  'use strict';
  ...
  exports['default'] = buildOperationUrl;
});
define('ember-api-actions/utils/collection-action', ['exports', 'ember', 'ember-api-actions/utils/build-url'], function (exports, _ember, _emberApiActionsUtilsBuildUrl) {
  'use strict';
  ...
  function instanceOp(options) {
    return function (payload) {
      ...
      var fullUrl = (0, _emberApiActionsUtilsBuildUrl.buildOperationUrl)(this, options.path, urlType, false);
    ...
    */
    ...
    off: function off(type, callback) {
      ...
      var listeners = this.listeners.filter(function (listener) {
        return listener.callback === callback && listener.url === _this.socket.io.uri && listener.type === type;
      });
    ...
    */
    ...
    close: function close() {
      ...
      this.listeners = this.listeners.filter(function (listener) {
        return listener.url === _this2.socket.io.uri;
      });
...
define('ember-websockets/services/websockets', ['exports', 'ember', 'ember-websockets/helpers/websocket-proxy', 'ember-websockets/helpers'], function (exports, _ember, _emberWebsocketsHelpersWebsocketProxy, _emberWebsocketsHelpers) {
  'use strict';
...
define("mock-socket/helpers/close-codes", ["exports"], function (exports) {
  /*
...
define('mock-socket/helpers/close-event', ['exports', 'mock-socket/helpers/event-prototype'], function (exports, _mockSocketHelpersEventPrototype) {
  'use strict';
...
define("mock-socket/helpers/delay", ["exports"], function (exports) {
  /*
...
define('mock-socket/helpers/event-prototype', ['exports'], function (exports) {
  'use strict';
...
define('mock-socket/socket-io', ['exports', 'mock-socket/helpers/delay', 'mock-socket/event-target', 'mock-socket/network-bridge', 'mock-socket/helpers/close-codes', 'mock-socket/helpers/normalize-url', 'mock-socket/event-factory'], function (exports, _mockSocketHelpersDelay, _mockSocketEventTarget, _mockSocketNetworkBridge, _mockSocketHelpersCloseCodes, _mockSocketHelpersNormalizeUrl, _mockSocketEventFactory) {
  'use strict';
  ...
  var SocketIO = (function (_EventTarget) {
      ...
      */
      (0, _mockSocketHelpersDelay['default'])(function delayCallback() {
        if (server) {
          ...
          server.dispatchEvent((0, _mockSocketEventFactory.createEvent)({ type: 'connect' }), server, this); // alias
          this.dispatchEvent((0, _mockSocketEventFactory.createEvent)({ type: 'connect', target: this }));
        } else {
          this.readyState = SocketIO.CLOSED;
          this.dispatchEvent((0, _mockSocketEventFactory.createEvent)({ type: 'error', target: this }));
          this.dispatchEvent((0, _mockSocketEventFactory.createCloseEvent)({
            type: 'close',
            target: this,
      ...
      this.addEventListener('close', function (event) {
        _this2.dispatchEvent((0, _mockSocketEventFactory.createCloseEvent)({
          type: 'disconnect',
          target: event.target,
          code: event.code
        }));
    ...
    */
    ...
    SocketIO.prototype.close = function close() {
      ...
      if (server) {
        server.dispatchEvent((0, _mockSocketEventFactory.createCloseEvent)({
          type: 'disconnect',
          target: this,
          code: _mockSocketHelpersCloseCodes['default'].CLOSE_NORMAL
        }), server);
    ...
    */
    ...
    SocketIO.prototype.join = function join(room) {
      _mockSocketNetworkBridge['default'].addMembershipToRoom(this, room);
    };
    ...
    SocketIO.prototype.leave = function leave(room) {
      _mockSocketNetworkBridge['default'].removeMembershipFromRoom(this, room);
    };
    ...
    _createClass(SocketIO, [{
      ...
      get: function get() {
        ...
        return {
          emit: function emit(event, data) {
            server.emit(event, data, { websockets: _mockSocketNetworkBridge['default'].websocketsLookup(_this.url, null, _this) });
          },
          to: function to(room) {
